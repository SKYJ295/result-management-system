...
class studentclass:
    def __init__(self,root):
        ...
        txt_addmission=Entry(self.root,textvariable=self.var_addmission,font=("goudy old style",15,'bold'),bg='lightyellow').place(x=480,y=140,width=200)
        ...
        #Buttons
        self.btn_add=Button(self.root,text='Save',font=("goudy old style",15,"bold"),bg="#2514e0",fg="white",cursor="hand2",command=self.add)
        ...
        self.CourseTable.heading("gender",text="genders")
